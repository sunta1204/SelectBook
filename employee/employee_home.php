						...
						<?php 
							while ($bookList=$stmt->fetch()) { ?>
								<tr>
									...
									<td>
										<button class="btn btn-primary" data-target="#edit_book<?=$bookList['b_id']?>" data-toggle="modal"><i class="fas fa-edit"></i>&nbsp; แก้ไข</button> || <button class="btn btn-danger"data-target="#delete_book<?=$bookList['b_id']?>" data-toggle="modal"><i class="fas fa-trash"></i>&nbsp; ลบ</button>
									</td>
								</tr>

								<!-- Modal edit book -->
							<form action="edit_book.php" method="post" style="color: #757575;">
									<div class="modal fade" id="edit_book<?=$bookList['b_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
											  aria-hidden="true">
									<!-- Change class .modal-sm to change the size of the modal -->
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											...
											<div class="card">
												...
												<div class="card-body px-lg-5 pt-0">
													<div class="form-row my-4">			            
													    <div class="col">
													        <div class="md-form">
													            ...
													            <input type="text" id="b_id" name="b_id" class="form-control" readonly="" value="<?=$bookList['b_id']?>" required="">
													    ...
													    <div class="col">
													        <div class="md-form">
													            <i class="fas fa-book prefix"></i>
													            <input type="text" name="b_name" id="b_name" class="form-control" value="<?=$bookList['b_name']?>" required="">
													            <label for="b_name">ชื่อหนังสือ</label>
													        </div>
													    </div>
													</div>
													<div class="md-form ">
													    <i class="fas fa-address-book prefix"></i>
													    <input type="text" name="b_author" id="b_author" class="form-control" value="<?=$bookList['b_author']?>" required="">
													    <label for="b_author">ผู้แต่ง</label>
													</div>
													<div class="form-row">
													    <div class="col-5">
													        <div class="md-form">
													            <i class="fas fa-dollar-sign prefix"></i>
													            <input type="text" name="b_price" id="b_price" class="form-control" value="<?=$bookList['b_price']?>" required="">
													            <label for="b_price">ราคา</label>
													        </div>
													    </div>
													    <div class="col-1">
													    ...
													    <div class="col-5">
													        <div class="md-form">
													            <i class="fas fa-layer-group prefix"></i>
													            <input type="text" name="b_stock" id="b_stock" class="form-control" value="<?=$bookList['b_stock']?>" required="">
													            <label for="b_stock">จำนวนหนังสือ</label>
													        </div>
													    </div>
													    <div class="col-1">
													...
													<button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit">แก้ไขหนังสือ</button>
												</div>
											</div>
										</div>
									</div>
							...
							<form action="delete_book.php" method="post">
									<div class="modal fade" id="delete_book<?=$bookList['b_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
											  aria-hidden="true">
									<!-- Change class .modal-sm to change the size of the modal -->
									<div class="modal-dialog modal-md" role="document">
										<div class="modal-content">
											...
											<div class="card">
												...
												<strong>ลบหนังสือ</strong>
												</h5>
												<!--Card content-->
												<div class="card-body px-lg-5 pt-0">
													<input type="hidden" name="b_id" id="b_id" value="<?=$bookList['b_id']?>">
													<div class="form-group my-4 text-center">
														<label class="text-primary" style="font-size: 20px;">คุณแน่ใจหรือไม่ที่ลบหนังสือ : </label> <label class="text-danger" style="font-size: 24px;"> <?=$bookList['b_name']?> </label>
													</div>
													
													<button class="btn btn-outline-danger btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit">ลบหนังสือ</button>
												</div>
											</div>
										</div>
									</div>
